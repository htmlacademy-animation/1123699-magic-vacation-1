...
class FullPageScroll {
  constructor() {
    ...
    this.pageOverlay = document.querySelector(`#pageOverlay`);
  ...
  changePageDisplay() {
    if (this.activeScreen === 2) {
      this.pageOverlay.classList.add(`is-animated`);
      setTimeout(() => {
        this.changeVisibilityDisplay();
      }, 400);
    } else {
      this.pageOverlay.classList.remove(`is-animated`);
      this.changeVisibilityDisplay();
    }
...
/***/ "./source/js/modules/split-animation.js":
/*!**********************************************!*\
  !*** ./source/js/modules/split-animation.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _accent_typography_builder_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accent-typography-builder.js */ "./source/js/modules/accent-typography-builder.js");
...
/* harmony import */ var _modules_split_animation_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/split-animation.js */ "./source/js/modules/split-animation.js");
// modules
...
Object(_modules_split_animation_js__WEBPACK_IMPORTED_MODULE_10__["default"])();
